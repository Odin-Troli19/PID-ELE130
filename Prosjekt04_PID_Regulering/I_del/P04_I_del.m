...
filename = 'P04_Ki_006.mat'; % Navnet på datafilen når online=0.
...
while ~JoyMainSwitch
    ...
    %Det passer med at figuren allerede viser grensene +100 og -100,
    %og prosjektteksten sier også at problemet er at I-leddet
    % ellers kan øke mer enn det maksimale pådraget på 100 %.

    %u_A(k) = max(min(I(k),100),-100);
